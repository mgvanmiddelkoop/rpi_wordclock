...
import wordclock_plugins.time_default.time_fivelanguages as time_fivelanguages
...
class wordclock_display:
    ...
    def __init__(self, config, wci):
        ...
        elif language == 'fivelanguages':
            self.taw = time_fivelanguages.time_fivelanguages()
